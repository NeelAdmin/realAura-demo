...
export default function SidebarDrawer({ isOpen, onClose, isMobile }: Props) {
  return (
    <>
      ...
      <div
        className={`fixed z-50 transform bg-white transition-transform duration-300 ${isMobile ? "top-4 right-0 bottom-4 my-5 rounded-2xl shadow-2xl" : "top-0 h-full"} ${isOpen ? "translate-x-0" : "translate-x-full"}`}
      >
